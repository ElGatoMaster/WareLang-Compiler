 ...
 * @author rebek
 */
public class tablaMetodosUs extends javax.swing.JDialog {
  DefaultTableModel tabla = new DefaultTableModel();
    ...
    public tablaMetodosUs(java.awt.Frame parent, boolean modal) {
        super(parent,"Tabla de Funciones", modal);
        initComponents();
   ...
   public void setSimbolos(ArrayList<String[]> simbolos){
    ...
    public void llenarTabla(){
        ...
        String columna[] = {"Identificador","Parametro1", "Parametro2", "Parametro3","Parametro4", "Parametro5", "Parametro6" };
